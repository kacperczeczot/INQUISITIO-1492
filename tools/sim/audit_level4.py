...
def main():
    ...
    report_lines = [
        ...
        f"**Wynik Bazy Poziomu 4 (Global):** `{base['global_score']:.1f} pkt` | 3p: `{base['cat_scores'].get('3p',0.0):.1f} pkt` | 4p: `{base['cat_scores'].get('4p',0.0):.1f} pkt` | 5p: `{base['cat_scores'].get('5p',0.0):.1f} pkt`",
        "",
