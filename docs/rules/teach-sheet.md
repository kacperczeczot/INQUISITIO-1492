...
## Rdzeń (A) — zawsze na stole

**Herezja + Inkwizytor + Werdykt + zakryte karty pod lokacje.**
...
- Bez nasłania: wybiera gracz z **najniższą Herezją** (remis → 1. gracz).
...
| Kabała z Toledo | **3 Fragmenty** + Herezja **3–7** od Ery 6 (w 3p: od Ery 7) |
