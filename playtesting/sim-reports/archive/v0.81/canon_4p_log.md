...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-17 03:09 | `v0.80` → `v0.81` | **Karta `kb-03` (Plotka Dworska): `heresy` → `1`** (`L3_KB-03_HERESY_PLUS1`) | 87.8 → **89.6** (`+1.8`) | 40.5 → 44.4 (`+3.9`) | 67.3 → 69.7 (`+2.4`) | 64.7 → **66.9** (`+2.2`) | 1.4% | 5.8% | 703.9s |
