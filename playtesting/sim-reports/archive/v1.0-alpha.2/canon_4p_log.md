...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 23:14 | `v1.0-alpha.1` → `v1.0-alpha.2` | **Karta `kb-11` (Tajny Emisariusz): `gold` → `0`** (`L3_KB-11_GOLD_MINUS1`) | 74.8 → **75.2** (`+0.4`) | 15.1 → 15.0 (`-0.1`) | 38.4 → 40.5 (`+2.1`) | 42.8 → **43.7** (`+0.9`) | 2.7% | 1.6% | 230.2s |
