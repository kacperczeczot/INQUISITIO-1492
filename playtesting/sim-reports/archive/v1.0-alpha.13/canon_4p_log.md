...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-20 23:11 | `v1.0-alpha.12` → `v1.0-alpha.13` | **Karta `gc-07` (Skrytobójstwo): `cost` → `0`** (`L3_GC-07_COST_MINUS1`) | 77.8 → **78.1** (`+0.3`) | 22.6 → 22.6 (`0.0`) | 33.3 → 33.6 (`+0.3`) | 45.4 → **45.6** (`+0.2`) | 0.3% | 1.5% | 782.1s |
