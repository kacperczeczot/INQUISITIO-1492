...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #9 | 1D | 2026-08-21 00:30 | `v1.0-alpha.18` → `v1.0-alpha.19` | **Karta `so-03` (Podejrzenie): `heresy` → `2`** (`L3_SO-03_HERESY_PLUS1`) | 79.7 → **79.9** (`+0.2`) | 24.4 → 24.1 (`-0.3`) | 29.0 → 28.9 (`-0.1`) | 44.9 → **44.8** (`-0.1`) | 0.3% | 1.5% | 767.0s |
