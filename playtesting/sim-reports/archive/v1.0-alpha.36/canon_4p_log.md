...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-23 03:48 | `v1.0-alpha.35` → `v1.0-alpha.36` | **Karta `kb-04` (Faworyt Dworu): `heresy` → `0`** (`L3_KB-04_HERESY_MINUS1`) | 59.5 → **63.2** (`+3.7`) | 23.0 → 27.2 (`+4.2`) | 11.0 → 16.9 (`+5.9`) | 30.6 → **35.0** (`+4.4`) | 0.0% | 3.3% | 615.0s |
