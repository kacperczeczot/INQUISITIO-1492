...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-19 00:12 | `v1.0-alpha.6` → `v1.0-alpha.7` | **Limit Er: offset +1 (nowy: 14)** (`L1_MAX_ERAS_PLUS1`) | 76.4 → **76.4** (`0.0`) | 20.6 → 22.3 (`+1.7`) | 38.7 → 38.7 (`0.0`) | 46.3 → **46.9** (`+0.6`) | 0.3% | 1.6% | 458.3s |
