...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-24 07:08 | `v1.0-alpha.63` → `v1.0-alpha.64` | **Karta `gc-08` (Zatrute Złoto): `heresy` → `2`** (`L3_GC-08_HERESY_PLUS1`) | 68.8 → **73.1** (`+4.3`) | 30.0 → 32.5 (`+2.5`) | 2.4 → 2.8 (`+0.4`) | 31.3 → **36.0** (`+4.7`) | 0.0% | 5.3% | 432.4s |
