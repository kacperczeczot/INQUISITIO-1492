...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-24 06:53 | `v1.0-alpha.61` → `v1.0-alpha.62` | **Karta `so-01` (Patrol Familiariuszy): `gold` → `2`** (`L3_SO-01_GOLD_SET2`) | 66.4 → **67.9** (`+1.5`) | 26.7 → 27.9 (`+1.2`) | 2.7 → 2.6 (`-0.1`) | 24.9 → **30.6** (`+5.7`) | 0.0% | 5.3% | 451.1s |
