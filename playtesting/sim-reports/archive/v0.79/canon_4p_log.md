...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-17 02:45 | `v0.78` → `v0.79` | **Karta `so-02` (Skarbiec Trybunału): `target_heresy` → `1`** (`L3_SO-02_TARGET_HERESY_PLUS1`) | 81.3 → **86.0** (`+4.7`) | 37.7 → 39.2 (`+1.5`) | 69.2 → 67.1 (`-2.1`) | 62.9 → **63.9** (`+1.0`) | 1.5% | 5.5% | 702.3s |
