...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-18 16:44 | `v0.99.25` → `v0.99.26` | **Limit Er: offset +1 (nowy: 14)** (`L1_MAX_ERAS_PLUS1`) | 75.8 → **75.8** (`0.0`) | 21.0 → 22.8 (`+1.8`) | 38.4 → 38.4 (`0.0`) | 45.5 → **46.1** (`+0.6`) | 0.3% | 1.5% | 727.9s |
