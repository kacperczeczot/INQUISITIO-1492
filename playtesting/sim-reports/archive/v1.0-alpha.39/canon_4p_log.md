...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-23 04:19 | `v1.0-alpha.38` → `v1.0-alpha.39` | **Karta `gc-09` (Lista Dłużników): `heresy` → `0`** (`L3_GC-09_HERESY_MINUS1`) | 65.2 → **68.9** (`+3.7`) | 25.5 → 27.4 (`+1.9`) | 17.4 → 19.0 (`+1.6`) | 36.7 → **38.8** (`+2.1`) | 0.0% | 3.4% | 613.5s |
