...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 02:13 | `v0.99.5` → `v0.99.6` | **Karta `caa-08` (Kaptur Nocy): `target_heresy` → `2`** (`L3_CAA-08_TARGET_HERESY_PLUS1`) | 56.2 → **61.4** (`+5.2`) | 12.8 → 12.9 (`+0.1`) | 48.2 → 41.2 (`-7.0`) | 40.1 → **39.1** (`-1.0`) | 2.5% | 1.4% | 384.4s |
