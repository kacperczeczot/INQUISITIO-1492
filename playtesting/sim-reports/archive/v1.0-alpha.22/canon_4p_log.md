...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #12 | 1D | 2026-08-21 07:53 | `v1.0-alpha.21` → `v1.0-alpha.22` | **Karta `so-10` (Oczyść Miasto): `heresy` → `1`** (`L3_SO-10_HERESY_MINUS1`) | 80.1 → **80.3** (`+0.2`) | 24.4 → 24.3 (`-0.1`) | 30.5 → 29.2 (`-1.3`) | 46.1 → **45.7** (`-0.4`) | 0.3% | 1.5% | 745.9s |
