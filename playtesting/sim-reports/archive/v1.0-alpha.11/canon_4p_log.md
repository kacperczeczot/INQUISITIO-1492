...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-20 22:44 | `v1.0-alpha.10` → `v1.0-alpha.11` | **Karta `gc-11` (Fałszywe Świadectwo Cechu): `cost` → `0`** (`L3_GC-11_COST_MINUS1`) | 76.9 → **77.4** (`+0.5`) | 22.9 → 22.6 (`-0.3`) | 34.2 → 31.8 (`-2.4`) | 45.6 → **44.8** (`-0.8`) | 0.3% | 1.5% | 768.6s |
