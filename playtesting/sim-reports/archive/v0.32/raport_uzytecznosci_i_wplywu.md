...
**Wersja Gry:** `v0.32` | **Data:** 2026-08-15 08:27 | **Próba:** 500 gier/setup (8000 gier/test) | **Czas Analizy:** 131.2s
...
| :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| **Gra bez Kroniki Dziejów (Talia Czasu OFF)** | 86.2 → 🟠 ** 66.8** (`-19.4`) | `-19.4 pkt` | 5.93 Er | 2.9% | 27.5% | Weryfikacja losowości Kroniki Dziejów (edyktów) |
| **Autodafé bez Cooldownu (możliwość co turę)** | 86.2 → 🟡 ** 83.8** (`-2.4`) | `-2.4 pkt` | 5.53 Er | 1.1% | 26.2% | Wpływ częstotliwości czyszczenia stołu przez Inkwizycję |
| **Autodafé rzadsze (co 4 Ery)** | 86.2 → 🟢 ** 90.1** (`⬆️ +3.9`) | `+3.9 pkt` | 5.57 Er | 1.2% | 26.3% | Wpływ częstotliwości czyszczenia stołu przez Inkwizycję |
| **Startowe Złoto zredukowane (-2 zł)** | 86.2 → 🔴 ** 18.8** (`-67.4`) | `-67.4 pkt` | 6.15 Er | 3.4% | 30.5% | Odporność gospodarki gry na ubóstwo i tempo startowe |
| **Startowe Złoto zwiększone (+1 zł)** | 86.2 → 🟠 ** 72.6** (`-13.6`) | `-13.6 pkt` | 5.42 Er | 1.1% | 24.3% | Odporność gospodarki gry na ubóstwo i tempo startowe |
| **Próg Oskarżenia podwyższony (+1)** | 86.2 → 🟠 ** 67.9** (`-18.3`) | `-18.3 pkt` | 5.72 Er | 1.4% | 26.9% | Czułość progu oskarżenia na dynamikę aresztowań |
| **Próg Oskarżenia obniżony (-1)** | 86.2 → 🟠 ** 74.9** (`-11.3`) | `-11.3 pkt` | 5.43 Er | 1.1% | 25.9% | Czułość progu oskarżenia na dynamikę aresztowań |
| **Limit Ręki zredukowany do 4 kart** | 86.2 → 🟠 ** 64.8** (`-21.4`) | `-21.4 pkt` | 5.84 Er | 2.2% | 32.8% | Wpływ limitu kart na ręce na decyzyjność graczy |
