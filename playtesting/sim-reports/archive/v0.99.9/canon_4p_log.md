...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-18 02:57 | `v0.99.8` → `v0.99.9` | **Karta `caa-06` (Ucieczka z Lochów): `cost` → `0`** (`L3_CAA-06_COST_MINUS1`) | 63.1 → **63.7** (`+0.6`) | 14.5 → 14.6 (`+0.1`) | 37.0 → 37.5 (`+0.5`) | 38.7 → **39.1** (`+0.4`) | 2.1% | 1.4% | 560.5s |
