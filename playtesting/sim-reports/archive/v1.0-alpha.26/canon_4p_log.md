...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-22 22:35 | `v1.0-alpha.25` → `v1.0-alpha.26` | **Gildia Cieni: Upadki offset -1** (`L2_GC_FALLS_MINUS1`) | 27.6 → **35.5** (`+7.9`) | 24.2 → 25.8 (`+1.6`) | 1.9 → 2.9 (`+1.0`) | 17.6 → **20.9** (`+3.3`) | 0.0% | 3.4% | 722.1s |
