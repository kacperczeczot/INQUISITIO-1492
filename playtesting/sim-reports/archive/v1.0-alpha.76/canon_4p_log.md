...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #10 | 1D | 2026-08-24 16:19 | `v1.0-alpha.75` → `v1.0-alpha.76` | **Karta `gc-06` (Szantaż): `cost` → `3`** (`L3_GC-06_COST_PLUS1`) | 80.2 → **82.3** (`+2.1`) | 28.1 → 28.1 (`0.0`) | 17.8 → 17.3 (`-0.5`) | 40.8 → **41.4** (`+0.6`) | 0.0% | 4.2% | 3153.8s |
