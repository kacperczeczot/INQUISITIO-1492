...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-22 23:25 | `v1.0-alpha.30` → `v1.0-alpha.31` | **Święte Oficjum: Skazania offset +1** (`L2_SO_CONDEMNS_PLUS1`) | 48.9 → **65.7** (`+16.8`) | 16.9 → 16.5 (`-0.4`) | 6.1 → 20.5 (`+14.4`) | 24.4 → **23.4** (`-1.0`) | 0.0% | 3.4% | 603.2s |
