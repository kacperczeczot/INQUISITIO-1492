...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-22 13:17 | `v1.0-alpha.22` → `v1.0-alpha.23` | **Karta `caa-12` (Skrytka w Murach): `gold` → `4`** (`L3_CAA-12_GOLD_PLUS1`) | 77.0 → **77.5** (`+0.5`) | 25.4 → 25.0 (`-0.4`) | 28.3 → 28.4 (`+0.1`) | 43.8 → **43.9** (`+0.1`) | 0.3% | 1.5% | 516.0s |
