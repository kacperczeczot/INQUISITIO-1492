...
| `L1_HAND_LIMIT_MINUS1` | Limit ręki: 5 → 4 | 81.2 → 🟢 ** 70.6** (`-10.6`) | 90.5 → 71.3 (`-19.2`) | 71.1 → 71.2 (`⬆️ +0.1`) | 82.0 → 69.4 (`-12.6`) | 🔴 POGARSZA GLOBALNIE |
...
| `L1_HAND_LIMIT_PLUS1` | Limit ręki: 5 → 6 | 81.2 → 🟢 ** 51.3** (`-29.9`) | 90.5 → 80.9 (`-9.6`) | 71.1 → 21.7 (`-49.4`) | 82.0 → 0.0 (`-82.0`) | 🔴 POGARSZA GLOBALNIE |
