...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-16 23:30 | `v0.73` → `v0.74` | **Karta `kt-08` (Areszt Wiedzy): `cost` → `1`** (`L3_KT-08_COST_MINUS1`) | 95.9 → **96.3** (`+0.4`) | 65.8 → 65.3 (`-0.5`) | 71.6 → 70.7 (`-0.9`) | 76.7 → **76.4** (`-0.3`) | 0.1% | 24.6% | 570.4s |
