...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-23 11:52 | `v1.0-alpha.46` → `v1.0-alpha.47` | **Liczba agentów: offset -1 (nowa: 2)** (`L1_AGENTS_MINUS1`) | 51.6 → **59.7** (`+8.1`) | 14.1 → 13.5 (`-0.6`) | 3.9 → 5.7 (`+1.8`) | 13.3 → **18.7** (`+5.4`) | 0.0% | 4.0% | 518.2s |
