[Strona główna](../../../../../README.md) > [v1.0-alpha.23](README.md) > [kandydaci_recznej_ablacji](kandydaci_recznej_ablacji.md)

---

# Kandydaci do ręcznej ablacji — Kanon 4P (v1.0-alpha.23)

**Wersja:** `v1.0-alpha.23` | **Patchy w sesji:** 1
