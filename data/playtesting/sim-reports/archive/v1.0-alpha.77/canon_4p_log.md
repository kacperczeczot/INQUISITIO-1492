...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #11 | 1D | 2026-08-24 17:42 | `v1.0-alpha.76` → `v1.0-alpha.77` | **Karta `gc-03` (Podrzucenie Księgi): `heresy` → `2`** (`L3_GC-03_HERESY_SET2`) | 79.6 → **82.4** (`+2.8`) | 28.1 → 30.2 (`+2.1`) | 17.3 → 13.9 (`-3.4`) | 41.4 → **41.7** (`+0.3`) | 0.0% | 4.2% | 4943.2s |
