...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-17 02:57 | `v0.79` → `v0.80` | **Karta `gc-01` (Przekupiony Strażnik): `gold` → `1`** (`L3_GC-01_GOLD_PLUS1`) | 86.0 → **87.8** (`+1.8`) | 39.2 → 40.5 (`+1.3`) | 67.1 → 67.3 (`+0.2`) | 63.9 → **64.7** (`+0.8`) | 1.4% | 5.9% | 684.4s |
