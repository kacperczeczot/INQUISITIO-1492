[Strona główna](../../../../../README.md) > [v0.77](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-17 02:08 | `v0.76` → `v0.77` | **Karta `gc-10` (Upadek Domu): `heresy` → `2`** (`L3_GC-10_HERESY_PLUS1`) | 67.4 → **76.2** (`+8.8`) | 39.1 → 41.0 (`+1.9`) | 65.8 → 69.2 (`+3.4`) | 57.8 → **62.7** (`+4.9`) | 1.4% | 5.5% | 679.8s |
