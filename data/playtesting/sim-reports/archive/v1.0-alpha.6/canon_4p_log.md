[Strona główna](../../../../../README.md) > [v1.0-alpha.6](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-19 00:04 | `v1.0-alpha.5` → `v1.0-alpha.6` | **Karta `kt-11` (Medytacja Sefirot): `cost` → `2`** (`L3_KT-11_COST_PLUS1`) | 76.2 → **76.4** (`+0.2`) | 20.8 → 20.6 (`-0.2`) | 39.6 → 38.7 (`-0.9`) | 46.6 → **46.3** (`-0.3`) | 0.5% | 1.6% | 452.5s |
