...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #5 | 1D | 2026-08-19 00:20 | `v1.0-alpha.7` → `v1.0-alpha.8` | **Karta `caa-10` (Echo Alhambry): `cost` → `1`** (`L3_CAA-10_COST_PLUS1`) | 76.4 → **76.5** (`+0.1`) | 22.3 → 22.3 (`0.0`) | 38.7 → 38.7 (`0.0`) | 46.9 → **46.9** (`0.0`) | 0.3% | 1.6% | 454.7s |
