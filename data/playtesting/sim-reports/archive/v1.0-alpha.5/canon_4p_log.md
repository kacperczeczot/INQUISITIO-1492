...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-18 23:57 | `v1.0-alpha.4` → `v1.0-alpha.5` | **Karta `gc-07` (Skrytobójstwo): `cost` → `1`** (`L3_GC-07_COST_MINUS1`) | 75.9 → **76.2** (`+0.3`) | 21.0 → 20.8 (`-0.2`) | 40.5 → 39.6 (`-0.9`) | 46.4 → **46.6** (`+0.2`) | 0.5% | 1.6% | 453.9s |
