...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-22 23:05 | `v1.0-alpha.29` | Akcja Gospodarcza: offset +1 (nowy: 2) | 48.9 → **54.5** (`+5.6`) vit 0.00→0.00 | 16.9 → 20.2 (`+3.3`) | 6.1 → 7.3 (`+1.2`) | 24.4 → **27.6** (`+3.2`) | 0.0% | 2.8% | 604.3s |
