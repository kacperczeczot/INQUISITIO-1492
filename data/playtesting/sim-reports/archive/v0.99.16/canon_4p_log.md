[Strona główna](../../../../../README.md) > [v0.99.16](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-18 13:19 | `v0.99.15` → `v0.99.16` | **Karta `so-04` (Publiczne Ostrzeżenie): `gold` → `1`** (`L3_SO-04_GOLD_PLUS1`) | 69.3 → **69.3** (`0.0`) | 14.2 → 14.5 (`+0.3`) | 36.8 → 37.3 (`+0.5`) | 40.8 → **40.7** (`-0.1`) | 0.6% | 1.5% | 656.4s |
