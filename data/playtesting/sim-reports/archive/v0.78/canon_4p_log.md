...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-17 02:33 | `v0.77` → `v0.78` | **Gildia Cieni: Upadki (bez Oficjum) offset +1** (`L2_GC_FALLS_NO_SO_PLUS1`) | 76.2 → **81.3** (`+5.1`) | 41.0 → 37.7 (`-3.3`) | 69.2 → 69.2 (`0.0`) | 62.7 → **62.9** (`+0.2`) | 1.6% | 5.5% | 688.5s |
