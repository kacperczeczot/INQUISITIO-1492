...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-23 22:58 | `v1.0-alpha.60` → `v1.0-alpha.61` | **Karta `so-03` (Podejrzenie): `heresy` → `3`** (`L3_SO-03_HERESY_PLUS1`) | 59.4 → **66.8** (`+7.4`) | 21.4 → 28.1 (`+6.7`) | 7.3 → 20.1 (`+12.8`) | 27.7 → **37.9** (`+10.2`) | 0.0% | 5.9% | 925.4s |
