...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-18 13:07 | `v0.99.14` → `v0.99.15` | **Karta `gc-08` (Zatrute Złoto): `cost` → `1`** (`L3_GC-08_COST_MINUS1`) | 68.6 → **69.3** (`+0.7`) | 14.3 → 14.2 (`-0.1`) | 36.7 → 36.8 (`+0.1`) | 38.1 → **40.8** (`+2.7`) | 0.6% | 1.5% | 659.0s |
