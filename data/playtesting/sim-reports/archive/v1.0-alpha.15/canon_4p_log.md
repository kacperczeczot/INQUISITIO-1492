[Strona główna](../../../../../README.md) > [v1.0-alpha.15](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #5 | 1D | 2026-08-20 23:38 | `v1.0-alpha.14` → `v1.0-alpha.15` | **Karta `so-03` (Podejrzenie): `heresy` → `1`** (`L3_SO-03_HERESY_PLUS1`) | 78.4 → **78.6** (`+0.2`) | 22.8 → 22.8 (`0.0`) | 34.4 → 34.7 (`+0.3`) | 45.9 → **46.1** (`+0.2`) | 0.3% | 1.5% | 796.0s |
