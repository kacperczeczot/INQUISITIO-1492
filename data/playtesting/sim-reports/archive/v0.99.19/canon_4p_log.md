[Strona główna](../../../../../README.md) > [v0.99.19](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 14:16 | `v0.99.18` → `v0.99.19` | **Karta `kb-11` (Tajny Emisariusz): `target_heresy` → `1`** (`L3_KB-11_TARGET_HERESY_PLUS1`) | 71.2 → **73.1** (`+1.9`) | 14.6 → 14.2 (`-0.4`) | 40.7 → 36.4 (`-4.3`) | 42.3 → **41.3** (`-1.0`) | 0.7% | 1.5% | 660.4s |
