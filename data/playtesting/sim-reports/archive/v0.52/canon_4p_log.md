[Strona główna](../../../../../README.md) > [v0.52](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-16 13:40 | `v0.51` → `v0.52` | **Karta `so-10` (Oczyść Miasto): `cost` → `5`** (`L3_SO-10_COST_PLUS1`) | 91.1 → **99.5** (`+8.4`) | 83.2 → 74.9 (`-8.3`) | 55.4 → 85.7 (`+30.3`) | 78.1 → **86.7** (`+8.6`) | 0.5% | 25.7% | 238.3s |
