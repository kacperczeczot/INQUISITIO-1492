[Strona główna](../../../../../README.md) > [v1.0-alpha.38](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-23 04:09 | `v1.0-alpha.37` → `v1.0-alpha.38` | **Karta `gc-04` (Informator): `heresy` → `0`** (`L3_GC-04_HERESY_MINUS1`) | 62.4 → **66.4** (`+4.0`) | 24.7 → 25.5 (`+0.8`) | 13.6 → 17.4 (`+3.8`) | 33.9 → **36.7** (`+2.8`) | 0.0% | 3.4% | 615.3s |
