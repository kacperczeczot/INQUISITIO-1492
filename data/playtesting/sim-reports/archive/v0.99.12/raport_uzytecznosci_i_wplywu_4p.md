[Strona główna](../../../../../README.md) > [v0.99.12](README.md) > [raport_uzytecznosci_i_wplywu_4p](raport_uzytecznosci_i_wplywu_4p.md)

---

# Raport Użyteczności i Wpływu Elementów w Kanonie 4P (Ablation & Impact Audit 4P) — Wersja v0.99.12

**Wersja Gry:** `v0.99.12` | **Data Badania:** 2026-08-18 11:08 | **Próba:** 5000 gier/setup (25000 gier na wariant) | **Ziarno:** 42
...
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| `time-01` | **Kapitulacja Grenady** | 66.0 → 🟠 ** 64.9** (`-1.1`) | `-1.1 pkt` | 6.16 Er | 1.9% | 🟢 Stabilizator tempa |
| `time-02` | **Godzina Policyjna** | 66.0 → 🟠 ** 67.8** (`⬆️ +1.8`) | `+1.8 pkt` | 6.12 Er | 1.8% | ⚠️ Spowalniacz |
| `time-03` | **Flota Odkrywców** | 66.0 → 🟠 ** 68.1** (`⬆️ +2.1`) | `+2.1 pkt` | 6.14 Er | 1.8% | ⚠️ Spowalniacz |
| `time-04` | **Rewizja w Dzielnicach** | 66.0 → 🟠 ** 67.8** (`⬆️ +1.8`) | `+1.8 pkt` | 6.16 Er | 2.1% | ⚠️ Spowalniacz |
| `time-05` | **Gorączka Donosów** | 66.0 → 🟠 ** 67.1** (`⬆️ +1.1`) | `+1.1 pkt` | 6.16 Er | 2.2% | ⚠️ Spowalniacz |
| `time-06` | **Nocna Obława** | 66.0 → 🟠 ** 65.5** (`-0.5`) | `-0.5 pkt` | 6.14 Er | 1.7% | ⚖️ Neutralna Kronika |
| `time-07` | **Bunt w Lochach** | 66.0 → 🟠 ** 65.9** (`-0.1`) | `-0.1 pkt` | 6.09 Er | 1.8% | 💤 Martwa karta kroniki (Δ≈0) |
| `time-08` | **Święte Przymierze** | 66.0 → 🟠 ** 67.4** (`⬆️ +1.4`) | `+1.4 pkt` | 6.04 Er | 1.5% | ⚠️ Spowalniacz |
| `time-09` | **Jarmark Królewski** | 66.0 → 🟠 ** 67.1** (`⬆️ +1.1`) | `+1.1 pkt` | 6.13 Er | 1.9% | ⚠️ Spowalniacz |
| `time-10` | **Amnestia Biskupia** | 66.0 → 🟠 ** 66.9** (`⬆️ +0.9`) | `+0.9 pkt` | 6.11 Er | 1.8% | ⚖️ Neutralna Kronika |
