[Strona główna](../../../../../README.md) > [v1.0-alpha.37](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-23 03:59 | `v1.0-alpha.36` → `v1.0-alpha.37` | **Karta `caa-07` (Szantaż Bractwa): `gold` → `3`** (`L3_CAA-07_GOLD_SET3`) | 62.0 → **65.7** (`+3.7`) | 27.2 → 24.7 (`-2.5`) | 16.9 → 13.6 (`-3.3`) | 35.0 → **33.9** (`-1.1`) | 0.0% | 3.4% | 614.6s |
