[Strona główna](../../../../../README.md) > [v1.0-alpha.17](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #7 | 1D | 2026-08-21 00:04 | `v1.0-alpha.16` → `v1.0-alpha.17` | **Karta `gc-02` (Czarny Rynek): `gold` → `4`** (`L3_GC-02_GOLD_PLUS1`) | 78.8 → **79.4** (`+0.6`) | 23.1 → 23.9 (`+0.8`) | 34.3 → 32.5 (`-1.8`) | 46.2 → **45.9** (`-0.3`) | 0.3% | 1.5% | 788.7s |
