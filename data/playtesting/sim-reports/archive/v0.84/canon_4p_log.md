...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #7 | 1D | 2026-08-17 04:06 | `v0.83` → `v0.84` | **Kabała Toledo: Pasmo Herezji 3–9** (`L2_KT_HERESY_HIGH_PLUS1`) | 92.9 → **94.2** (`+1.3`) | 47.2 → 45.9 (`-1.3`) | 67.3 → 71.7 (`+4.4`) | 68.3 → **69.6** (`+1.3`) | 1.1% | 5.5% | 1947.7s |
