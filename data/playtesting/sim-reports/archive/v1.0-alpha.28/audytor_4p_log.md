...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-22 22:55 | `v1.0-alpha.28` | Zastosowano regułę L1_INTRIGUE_GOLD_DOUBLE | 48.9 → **54.5** (`+5.6`) vit 0.00→0.00 | 16.9 → 20.2 (`+3.3`) | 6.1 → 7.3 (`+1.2`) | 24.4 → **27.6** (`+3.2`) | 0.0% | 2.8% | 571.4s |
