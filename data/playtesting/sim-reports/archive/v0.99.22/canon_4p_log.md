...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-18 14:49 | `v0.99.21` → `v0.99.22` | **Karta `so-11` (Dekret Czystości Wiary): `heresy` → `1`** (`L3_SO-11_HERESY_PLUS1`) | 75.3 → **75.5** (`+0.2`) | 13.0 → 13.0 (`0.0`) | 37.2 → 37.1 (`-0.1`) | 42.2 → **42.2** (`0.0`) | 0.6% | 1.5% | 677.5s |
