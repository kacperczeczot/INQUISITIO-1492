[Strona główna](../../../../../README.md) > [v0.72](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-16 23:11 | `v0.71` → `v0.72` | **Karta `so-05` (Wezwanie do Trybunału): `target_heresy` → `1`** (`L3_SO-05_TARGET_HERESY_MINUS1`) | 88.4 → **93.7** (`+5.3`) | 68.0 → 64.4 (`-3.6`) | 53.9 → 67.8 (`+13.9`) | 69.2 → **74.5** (`+5.3`) | 0.1% | 24.0% | 817.0s |
