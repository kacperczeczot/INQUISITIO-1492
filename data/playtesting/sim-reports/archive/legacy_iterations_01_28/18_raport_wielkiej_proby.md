[Strona główna](../../../../../README.md) > [legacy_iterations_01_28](README.md) > [18_raport_wielkiej_proby](18_raport_wielkiej_proby.md)

---

# Raport 18: Wielka Próba Uczenia Botów i Analizy Głębokie (80,000 Partii)

**Wielkość Próby:** 5000 gier na setup (16 setupów) | **Łącznie:** 80,000 gier | **Czas Symulacji:** 11.34s
**Global Game Balance Index:** `49.5 / 100.0 pkt`
...
- **Rozgrywki 4-osobowe (4p Avg):** `28.1 / 100.0 pkt` (5 setupów)
...
| `4p-core` | 4 | **  0.0** | 5.11 | 1.1% | 26.7% | 0.57zł | 5.49 | 1.21 | 2.65 | WARNING: Ostrzeżenie Ubóstwa: 26.7% tur w pasie z braku złota; WARNING: Ostrzeżenie Anomali Wygranej: partia wygrana w Erze 1 |
| `4p-no-cienie` | 4 | **  0.0** | 4.92 | 1.9% | 27.7% | 0.62zł | 5.74 | 1.15 | 2.98 | WARNING: Porażenie tempa: 4.92 Er (zalecane 5.0–7.0); WARNING: Ostrzeżenie Ubóstwa: 27.7% tur w pasie z braku złota; WARNING: Ostrzeżenie Anomali Wygranej: partia wygrana w Erze 1 |
| `4p-no-kabala` | 4 | **  0.0** | 4.80 | 5.3% | 29.2% | 0.36zł | 5.77 | 1.16 | 2.84 | WARNING: Porażenie tempa: 4.80 Er (zalecane 5.0–7.0); WARNING: Podwyższony limit Er: 5.3%; WARNING: Ostrzeżenie Ubóstwa: 29.2% tur w pasie z braku złota; WARNING: Ostrzeżenie Anomali Wygranej: partia wygrana w Erze 1 |
