[Strona główna](../../../../../README.md) > [v1.0-alpha.9](README.md) > [raport_telemetrii_4p](raport_telemetrii_4p.md)

---

# Raport Telemetrii i Szans Wygranych (Win Shares) dla Wszystkich 16 Setupów — Wersja Balansu: v1.0-alpha.9

**Wersja Balansu:** `v1.0-alpha.9` | **Data:** 2026-08-19 14:18 | **Wielkość Próby:** 10000 gier/setup (160000 gier łącznie) | **Czas Symulacji:** 16.1s
