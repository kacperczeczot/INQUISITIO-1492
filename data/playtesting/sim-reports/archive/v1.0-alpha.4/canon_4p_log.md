...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 23:49 | `v1.0-alpha.3` → `v1.0-alpha.4` | **Limit Er: offset +1 (nowy: 13)** (`L1_MAX_ERAS_PLUS1`) | 74.7 → **75.9** (`+1.2`) | 18.6 → 21.0 (`+2.4`) | 40.5 → 40.5 (`0.0`) | 45.5 → **46.4** (`+0.9`) | 0.5% | 1.6% | 459.1s |
