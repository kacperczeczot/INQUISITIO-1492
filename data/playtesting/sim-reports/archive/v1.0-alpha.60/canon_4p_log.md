...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-23 22:42 | `v1.0-alpha.59` → `v1.0-alpha.60` | **Gildia Cieni: Upadki offset +1** (`L2_GC_FALLS_PLUS1`) | 56.0 → **60.4** (`+4.4`) | 17.9 → 21.4 (`+3.5`) | 9.4 → 7.3 (`-2.1`) | 25.2 → **27.7** (`+2.5`) | 0.0% | 5.6% | 899.3s |
