[Strona główna](../../../../../README.md) > [v0.99.17](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-18 13:30 | `v0.99.16` → `v0.99.17` | **Karta `caa-12` (Skrytka w Murach): `heresy` → `0`** (`L3_CAA-12_HERESY_MINUS1`) | 69.3 → **70.7** (`+1.4`) | 14.5 → 14.8 (`+0.3`) | 37.3 → 42.8 (`+5.5`) | 40.7 → **43.1** (`+2.4`) | 0.7% | 1.5% | 653.4s |
