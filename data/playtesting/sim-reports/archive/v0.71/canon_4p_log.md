[Strona główna](../../../../../README.md) > [v0.71](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-16 22:57 | `v0.70` → `v0.71` | **Święte Oficjum: Skazania offset +1** (`L2_SO_CONDEMNS_PLUS1`) | 69.9 → **88.4** (`+18.5`) | 72.8 → 68.0 (`-4.8`) | 43.2 → 53.9 (`+10.7`) | 61.0 → **69.2** (`+8.2`) | 0.1% | 23.9% | 627.4s |
