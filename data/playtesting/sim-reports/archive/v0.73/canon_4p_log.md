[Strona główna](../../../../../README.md) > [v0.73](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-16 23:20 | `v0.72` → `v0.73` | **Karta `gc-02` (Czarny Rynek): `gold` → `1`** (`L3_GC-02_GOLD_MINUS1`) | 93.7 → **95.9** (`+2.2`) | 64.4 → 65.8 (`+1.4`) | 67.8 → 71.6 (`+3.8`) | 74.5 → **76.7** (`+2.2`) | 0.1% | 24.6% | 547.8s |
