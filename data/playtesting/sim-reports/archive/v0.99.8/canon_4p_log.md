[Strona główna](../../../../../README.md) > [v0.99.8](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-18 02:48 | `v0.99.7` → `v0.99.8` | **Karta `caa-08` (Kaptur Nocy): `heresy` → `0`** (`L3_CAA-08_HERESY_MINUS1`) | 62.7 → **63.1** (`+0.4`) | 14.5 → 14.5 (`0.0`) | 38.7 → 37.0 (`-1.7`) | 39.1 → **38.7** (`-0.4`) | 2.1% | 1.4% | 579.7s |
