[Strona główna](../../../../../README.md) > [v0.85](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #8 | 1D | 2026-08-17 04:33 | `v0.84` → `v0.85` | **Karta `caa-08` (Kaptur Nocy): `target_heresy` → `1`** (`L3_CAA-08_TARGET_HERESY_PLUS1`) | 94.2 → **94.5** (`+0.3`) | 45.9 → 46.2 (`+0.3`) | 71.7 → 67.0 (`-4.7`) | 69.6 → **68.2** (`-1.4`) | 1.1% | 5.6% | 1545.3s |
