[Strona główna](../../../../../README.md) > [v0.99.24](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 16:19 | `v0.99.23` → `v0.99.24` | **Karta `gc-04` (Informator): `target_heresy` → `1`** (`L3_GC-04_TARGET_HERESY_PLUS1`) | 75.5 → **76.2** (`+0.7`) | 21.2 → 21.2 (`0.0`) | 37.1 → 37.6 (`+0.5`) | 44.9 → **45.4** (`+0.5`) | 0.6% | 1.5% | 780.9s |
