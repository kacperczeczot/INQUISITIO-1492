...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 23:23 | `v1.0-alpha.2` → `v1.0-alpha.3` | **Limit Er: offset +1 (nowy: 12)** (`L1_MAX_ERAS_PLUS1`) | 75.2 → **76.5** (`+1.3`) | 15.0 → 18.6 (`+3.6`) | 40.5 → 40.5 (`0.0`) | 43.7 → **45.5** (`+1.8`) | 1.9% | 1.6% | 229.0s |
