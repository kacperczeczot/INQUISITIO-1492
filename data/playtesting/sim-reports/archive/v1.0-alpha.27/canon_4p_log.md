...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-22 22:45 | `v1.0-alpha.26` → `v1.0-alpha.27` | **Gildia Cieni: Upadki offset -1** (`L2_GC_FALLS_MINUS1`) | 35.3 → **48.7** (`+13.4`) | 25.8 → 16.9 (`-8.9`) | 2.9 → 6.1 (`+3.2`) | 20.9 → **24.4** (`+3.5`) | 0.0% | 3.4% | 641.0s |
