# Raport Telemetrii i Szans Wygranych (Win Shares) dla Wszystkich 16 Setupów — Wersja Balansu: v1.0-alpha.101

**Wersja Balansu:** `v1.0-alpha.101` | **Data:** 2026-08-30 00:43 | **Wielkość Próby:** 10000 gier/setup (160000 gier łącznie) | **Czas Symulacji:** 0.44s
...
| :--- | :---: | :--- | :---: | :--- |
| **GC** | 31.1% | `3p-oficjum-kabala-gildia` | +26.4% | 🟡 DOMINUJE |
| **KB** | 34.3% | `3p-oficjum-alandalus-korona` | +22.7% | 🟡 DOMINUJE |
| **CAA** | 28.9% | `3p-cienie-kabala-gildia` | +13.6% | 🟡 DOMINUJE |
| **KT** | 24.9% | `3p-oficjum-kabala-gildia` | -13.4% | 🟡 SŁABA |
| **SO** | 26.2% | `3p-oficjum-kabala-gildia` | -12.9% | 🟡 SŁABA |
...
| **Era 3** | 2,798 |   1.8% | `█                   ` | 🟡 Wczesna / Szybka gra |
| **Era 4** | 14,498 |   9.1% | `█████               ` | 🟡 Wczesna / Szybka gra |
| **Era 5** | 30,817 |  19.4% | `██████████          ` | 🟢 Złote Okno Rozgrywki (Ery 5–7) |
| **Era 6** | 36,195 |  22.7% | `███████████         ` | 🟢 Złote Okno Rozgrywki (Ery 5–7) |
| **Era 7** | 35,354 |  22.2% | `███████████         ` | 🟢 Złote Okno Rozgrywki (Ery 5–7) |
| **Era 8** | 20,391 |  12.8% | `██████              ` | 🟡 Przedłużona / Późna gra |
| **Era 9** | 9,923 |   6.2% | `███                 ` | 🟡 Przedłużona / Późna gra |
...
| **Era 1** | 0 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 2** | 218 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 3** | 2,798 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 4** | 14,498 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 5** | 30,817 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 6** | 36,195 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 7** | 35,354 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 8** | 20,391 | 0 | 0 | 0 | 0 | 0 | - |
| **Era 9** | 9,923 | 0 | 0 | 0 | 0 | 0 | - |
