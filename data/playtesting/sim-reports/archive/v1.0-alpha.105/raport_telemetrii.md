# Raport Telemetrii i Szans Wygranych (Win Shares) dla Wszystkich 16 Setupów — Wersja Balansu: v1.0-alpha.105

**Wersja Balansu:** `v1.0-alpha.105` | **Data:** 2026-08-30 01:59 | **Wielkość Próby:** 10000 gier/setup (160000 gier łącznie) | **Czas Symulacji:** 0.45s
...
| `3p-oficjum-alandalus-gildia` | 3 | 🔴 ** 20.6** | 🟠 68.5 | 33.3% | 41.0% | 26.3% | - | - | 32.7% | 🔴 ODCHYLONY |
| `3p-oficjum-alandalus-kabala` | 3 | 🔴 ** 12.5** | 🔴 41.5 | 33.3% | 49.8% | 22.4% | - | 27.7% | - | 🔴 ODCHYLONY |
| `3p-oficjum-alandalus-korona` | 3 | 🔴 ** 13.5** | 🔴 44.9 | 33.3% | 34.4% | 19.4% | 46.2% | - | - | 🔴 ODCHYLONY |
| `3p-oficjum-kabala-gildia` | 3 | 🔴 ** 10.6** | 🔴 35.1 | 33.3% | 30.5% | - | - | 18.3% | 51.3% | 🔴 ODCHYLONY |
| `3p-oficjum-korona-gildia` | 3 | 🔴 ** 23.7** | 🟠 78.6 | 33.3% | 35.9% | - | 27.4% | - | 36.7% | 🔴 ODCHYLONY |
| `3p-oficjum-korona-kabala` | 3 | 🔴 ** 24.6** | 🟡 81.8 | 33.3% | 38.5% | - | 30.3% | 31.2% | - | 🔴 ODCHYLONY |
...
| `3p-oficjum-alandalus-gildia` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/4103 wygranych (<8%) — gra tylko stosy |
| `3p-oficjum-alandalus-kabala` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/4981 wygranych (<8%) — gra tylko stosy |
| `3p-oficjum-alandalus-korona` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/3440 wygranych (<8%) — gra tylko stosy |
| `3p-oficjum-kabala-gildia` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/3047 wygranych (<8%) — gra tylko stosy |
| `3p-oficjum-korona-gildia` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/3590 wygranych (<8%) — gra tylko stosy |
| `3p-oficjum-korona-kabala` | ⚠️ Ostrzeżenie Witalności | 1.200 | Martwa ścieżka skazania (swiete-oficjum): 0/3845 wygranych (<8%) — gra tylko stosy |
...
| :--- | :---: | :--- |
| `3p-oficjum-kabala-gildia` | 🔴 ** 10.6** | GC dominuje (51.3% vs ideal 33.3%) |
| `3p-oficjum-alandalus-kabala` | 🔴 ** 12.5** | SO dominuje (49.8% vs ideal 33.3%) |
| `3p-oficjum-alandalus-korona` | 🔴 ** 13.5** | CAA za słaba (19.4% vs ideal 33.3%) |
| `3p-oficjum-alandalus-gildia` | 🔴 ** 20.6** | SO dominuje (41.0% vs ideal 33.3%) |
| `3p-oficjum-korona-gildia` | 🔴 ** 23.7** | KB za słaba (27.4% vs ideal 33.3%) |
| `3p-oficjum-korona-kabala` | 🔴 ** 24.6** | SO dominuje (38.5% vs ideal 33.3%) |
