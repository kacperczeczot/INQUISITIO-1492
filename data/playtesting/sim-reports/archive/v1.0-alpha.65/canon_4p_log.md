[Strona główna](../../../../../README.md) > [v1.0-alpha.65](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-24 07:15 | `v1.0-alpha.64` → `v1.0-alpha.65` | **Wariant: Prędkość Ruchu Inkwizytora = 2** (`L4_INQUISITOR_SPEED2`) | 69.6 → **71.5** (`+1.9`) | 32.5 → 28.9 (`-3.6`) | 2.8 → 2.2 (`-0.6`) | 36.0 → **26.1** (`-9.9`) | 0.0% | 5.3% | 429.6s |
