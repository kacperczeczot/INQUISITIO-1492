[Strona główna](../../../../../README.md) > [v0.99.18](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #5 | 1D | 2026-08-18 13:41 | `v0.99.17` → `v0.99.18` | **Karta `gc-01` (Przekupiony Strażnik): `cost` → `2`** (`L3_GC-01_COST_PLUS1`) | 70.7 → **71.2** (`+0.5`) | 14.8 → 14.6 (`-0.2`) | 42.8 → 40.7 (`-2.1`) | 43.1 → **42.3** (`-0.8`) | 0.7% | 1.5% | 654.9s |
