...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #6 | 1D | 2026-08-17 03:34 | `v0.82` → `v0.83` | **Karta `gc-12` (Złodziejski Zwiad): `heresy` → `2`** (`L3_GC-12_HERESY_PLUS1`) | 92.5 → **92.9** (`+0.4`) | 47.4 → 47.2 (`-0.2`) | 66.8 → 67.3 (`+0.5`) | 67.6 → **68.3** (`+0.7`) | 1.2% | 5.5% | 730.1s |
