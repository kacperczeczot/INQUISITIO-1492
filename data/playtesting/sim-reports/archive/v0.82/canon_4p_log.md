...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #5 | 1D | 2026-08-17 03:21 | `v0.81` → `v0.82` | **Karta `kb-02` (Pobór Podatków): `target_heresy` → `1`** (`L3_KB-02_TARGET_HERESY_PLUS1`) | 89.6 → **92.5** (`+2.9`) | 44.4 → 47.4 (`+3.0`) | 69.7 → 66.8 (`-2.9`) | 66.9 → **67.6** (`+0.7`) | 1.2% | 5.7% | 731.7s |
