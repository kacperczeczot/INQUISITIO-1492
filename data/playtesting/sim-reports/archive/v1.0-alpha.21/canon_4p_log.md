[Strona główna](../../../../../README.md) > [v1.0-alpha.21](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #11 | 1D | 2026-08-21 07:41 | `v1.0-alpha.20` → `v1.0-alpha.21` | **Karta `so-09` (Świadek Koronny): `cost` → `1`** (`L3_SO-09_COST_MINUS1`) | 80.0 → **80.1** (`+0.1`) | 24.4 → 24.4 (`0.0`) | 30.2 → 30.5 (`+0.3`) | 45.9 → **46.1** (`+0.2`) | 0.3% | 1.5% | 4329.2s |
