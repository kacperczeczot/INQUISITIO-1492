...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-18 16:32 | `v0.99.24` → `v0.99.25` | **Karta `kb-10` (Pieczęć Korony): `target_heresy` → `1`** (`L3_KB-10_TARGET_HERESY_PLUS1`) | 76.2 → **75.8** (`-0.4`) | 21.2 → 21.0 (`-0.2`) | 37.6 → 38.4 (`+0.8`) | 45.4 → **45.5** (`+0.1`) | 0.5% | 1.5% | 733.8s |
