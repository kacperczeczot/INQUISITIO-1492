...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-22 22:21 | `v1.0-alpha.24` → `v1.0-alpha.25` | **Karta `kb-09` (Dekret Królewski): `gold` → `3`** (`L3_KB-09_GOLD_SET3`) | 11.9 → **27.2** (`+15.3`) | 12.5 → 24.2 (`+11.7`) | 1.4 → 1.9 (`+0.5`) | 8.6 → **17.6** (`+9.0`) | 0.0% | 3.5% | 292.5s |
