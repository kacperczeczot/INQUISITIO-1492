[Strona główna](../../../../../README.md) > [v0.99.20](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-18 14:27 | `v0.99.19` → `v0.99.20` | **Karta `gc-08` (Zatrute Złoto): `heresy` → `1`** (`L3_GC-08_HERESY_PLUS1`) | 73.1 → **73.5** (`+0.4`) | 14.2 → 14.5 (`+0.3`) | 36.4 → 33.5 (`-2.9`) | 41.3 → **40.7** (`-0.6`) | 0.7% | 1.5% | 651.7s |
