[Strona główna](../../../../../README.md) > [v0.99.7](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 02:38 | `v0.99.6` → `v0.99.7` | **Karta `kt-10` (Pieczęć Salomona): `heresy` → `2`** (`L3_KT-10_HERESY_PLUS1`) | 61.8 → **62.7** (`+0.9`) | 12.9 → 14.5 (`+1.6`) | 41.2 → 38.7 (`-2.5`) | 39.1 → **39.1** (`0.0`) | 2.1% | 1.4% | 634.9s |
