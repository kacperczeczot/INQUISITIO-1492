[Strona główna](../../../../../README.md) > [v0.99.14](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #1 | 1D | 2026-08-18 12:56 | `v0.99.13` → `v0.99.14` | **Karta `kb-01` (Rozkaz Dworu): `target_heresy` → `1`** (`L3_KB-01_TARGET_HERESY_PLUS1`) | 65.8 → **68.6** (`+2.8`) | 14.2 → 14.3 (`+0.1`) | 40.5 → 36.7 (`-3.8`) | 38.1 → **38.1** (`0.0`) | 0.6% | 1.5% | 645.5s |
