...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #3 | 1D | 2026-08-18 14:38 | `v0.99.20` → `v0.99.21` | **Karta `kt-05` (Wskazówka Cyklu): `heresy` → `1`** (`L3_KT-05_HERESY_PLUS1`) | 73.5 → **75.3** (`+1.8`) | 14.5 → 13.0 (`-1.5`) | 33.5 → 37.2 (`+3.7`) | 40.7 → **42.2** (`+1.5`) | 0.6% | 1.5% | 655.0s |
