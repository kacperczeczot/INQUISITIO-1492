...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #2 | 1D | 2026-08-22 23:35 | `v1.0-alpha.31` → `v1.0-alpha.32` | **Karta `kb-09` (Dekret Królewski): `heresy` → `0`** (`L3_KB-09_HERESY_MINUS1`) | 62.2 → **70.3** (`+8.1`) | 16.4 → 19.9 (`+3.5`) | 19.0 → 23.5 (`+4.5`) | 22.8 → **24.7** (`+1.9`) | 0.0% | 3.4% | 620.9s |
