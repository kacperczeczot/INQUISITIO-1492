# Raport Audytu Poziomu 1 (Główne Mechaniki Systemowe) — Wersja Balansu: v1.0-alpha.167

**Wersja Balansu:** `v1.0-alpha.167` | **Data:** 2026-08-30 17:14 | **Przeanalizowano Wariantów:** 45 | **Próba:** 10000 gier/setup | **Czas:** 68.73s
...
| `L1_THRESHOLD_4P_MINUS1` | Próg Oskarżenia (4p): 5 → 4 | 84.5 → 🟡 ** 85.1** (`⬆️ +0.6`) | 70.8 → 70.8 (`= 0.0`) | 90.3 → 92.1 (`⬆️ +1.8`) | 92.4 → 92.4 (`= 0.0`) | 🟢 POPRAWIA GLOBALNIE |
| `L1_THRESHOLD_3P_MINUS1` | Próg Oskarżenia (3p): 6 → 5 | 84.5 → 🟡 ** 84.9** (`⬆️ +0.4`) | 70.8 → 72.0 (`⬆️ +1.2`) | 90.3 → 90.3 (`= 0.0`) | 92.4 → 92.4 (`= 0.0`) | ⚪ OPTYMALNY |
| `L1_THRESHOLD_MINUS1` | Próg Oskarżenia (global): 6/5/8 → 5/4/7 | 84.5 → 🟡 ** 82.1** (`🔻 -2.4`) | 70.8 → 72.0 (`⬆️ +1.2`) | 90.3 → 92.1 (`⬆️ +1.8`) | 92.4 → 82.3 (`🔻 -10.1`) | 🔴 POGARSZA GLOBALNIE |
| `L1_THRESHOLD_PLUS1` | Próg Oskarżenia (global): 6/5/8 → 7/6/9 | 84.5 → 🟡 ** 81.0** (`🔻 -3.5`) | 70.8 → 63.4 (`🔻 -7.4`) | 90.3 → 84.6 (`🔻 -5.7`) | 92.4 → 95.1 (`⬆️ +2.7`) | 🔴 POGARSZA GLOBALNIE |
...
| `L1_THRESHOLD_4P_PLUS1` | Próg Oskarżenia (4p): 5 → 6 | 84.5 → 🟡 ** 82.6** (`🔻 -1.9`) | 70.8 → 70.8 (`= 0.0`) | 90.3 → 84.6 (`🔻 -5.7`) | 92.4 → 92.4 (`= 0.0`) | 🔴 POGARSZA GLOBALNIE |
...
| `L1_THRESHOLD_4P_PLUS2` | Próg Oskarżenia (4p): 5 → 7 | 84.5 → 🟡 ** 82.0** (`🔻 -2.5`) | 70.8 → 70.8 (`= 0.0`) | 90.3 → 82.7 (`🔻 -7.6`) | 92.4 → 92.4 (`= 0.0`) | 🔴 POGARSZA GLOBALNIE |
...
| `L1_THRESHOLD_3P_MINUS2` | Próg Oskarżenia (3p): 6 → 4 | 84.5 → 🟡 ** 81.4** (`🔻 -3.1`) | 70.8 → 61.4 (`🔻 -9.4`) | 90.3 → 90.3 (`= 0.0`) | 92.4 → 92.4 (`= 0.0`) | 🔴 POGARSZA GLOBALNIE |
...
| `L1_THRESHOLD_4P_MINUS2` | Próg Oskarżenia (4p): 5 → 3 | 84.5 → 🟡 ** 81.0** (`🔻 -3.5`) | 70.8 → 70.8 (`= 0.0`) | 90.3 → 79.9 (`🔻 -10.4`) | 92.4 → 92.4 (`= 0.0`) | 🔴 POGARSZA GLOBALNIE |
