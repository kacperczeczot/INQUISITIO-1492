[Strona główna](../../../../../README.md) > [v0.99.10](README.md) > [canon_4p_log](canon_4p_log.md)
...
| :---: | :---: | :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| #4 | 1D | 2026-08-18 03:07 | `v0.99.9` → `v0.99.10` | **Karta `so-08` (Nasłanie Inkwizytora): `cost` → `0`** (`L3_SO-08_COST_MINUS1`) | 63.7 → **63.2** (`-0.5`) | 14.6 → 14.7 (`+0.1`) | 37.5 → 37.7 (`+0.2`) | 39.1 → **39.0** (`-0.1`) | 2.1% | 1.4% | 545.2s |
