...
class AutoBalancer5P:
    ...
    def run(self):
        ...
        while not self.stop_requested:
            ...
            curr_base_overrides = extract_config_overrides(current_raw_cfg, setup_type="5p")
            ...
            if accepted_candidate and best_ver_res is not None and effective_rule_params is not None:
                ...
                print(f"   Testowany kandydat: {rule_id} ({rule_name})")
            ...
            if accepted_candidate and best_ver_res is not None and effective_rule_params is not None:
                ...
                if current_phase >= self.args.max_depth:
                    print(
                        f"\n🏁 Brak zmian makro przynoszących zysk w 5P na {current_phase}D "
