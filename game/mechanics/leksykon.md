...
| :--- | :--- |
| **Limit:** | `Limit: 1 / gracza / Erę.` · `Limit: 1 / Erę.` · `Limit: 1 nasłanie / gracza / Erę.` · `Limit: bez Przesuń z karty / tę Erę.` |
...
| S14 | `Limit: bez Przesuń z karty / tę Erę.` | Anti-AP ruchu (np. po reakcji) |
