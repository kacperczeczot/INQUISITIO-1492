...
- Cel ma Herezję ≥ progu (domyślnie **7**).
- Nie oskarżano tego gracza w tej Erze.
- Oskarżyciel nie jest celem tego samego oskarżenia.

Powód narracyjny (Agent w lokacji, Autodafé, plotka) pomaga przy stole, ale w prototypie wystarczy **ogłoszenie**.
...
Gate: przynajmniej jedno oskarżenie z prawdziwym napięciem głosów. Bez Haków wpływających na głos.

## Playtest UX

Emocja Werdyktu 1–5; downtime bloku; czy głosowanie jest puste formalnie.
