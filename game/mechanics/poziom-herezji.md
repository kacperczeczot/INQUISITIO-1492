...
Ikoniczna mechanika tytułu — **centralny filar** obok Inkwizytora, Lochów/Marionetek, Haków i karta specjalna.
...
5. **Marionetka wykryta** — skandal: właściciel **+2 Herezja** (prototyp); znacznik znika.
6. **Werdykt — uniewinnienie** — oskarżyciel **+1 Herezja** (wstyd publiczny).
7. **Kronika Dziejów / lokacje** — edykty i efekty Cienia.
...
- [`lochy-przesluchania.md`](lochy-przesluchania.md) — wybór: Herezja / Hak / Marionetka.
