...
| [**Gildia Cieni**](gildia-cieni.md) | Półświatek kastylijski (*hampa*), szantaż | Donosy, fałszywi świadkowie, Haki | **2 Upadki** rywali (3 bez Oficjum) |
...
```mermaid
flowchart TD
    SO["✝️ ŚWIĘTE OFICJUM<br>(Prawo Wiary & Terror)"]
    KB["👑 KORONA & BORGIOWIE<br>(Władza Świecka & Dekrety)"]
    CAA["🌙 CIENIE AL-ANDALUS<br>(Ocalenie Relikwii)"]
    KT["📜 KABAŁA Z TOLEDO<br>(Sekretny Kodeks)"]
    GC["🗡️ GILDIA CIENI<br>(Szantaż & Półświatek)"]

    SO -- "Polowanie na Herezję" --> KT
    SO -- "Śledztwo i Stosy" --> CAA
    KB -- "Sojusz Polityczny / Rywalizacja" --> SO
    GC -- "Kupowanie Straży i Haki" --> KB
    GC -- "Szantaż i Donosy" --> SO
    KT -- "Ukryte Sojusze Wiedzy" --> CAA
    CAA -- "Ewakuacja przed Ogniem" --> SO
    GC -- "Prowokowanie Upadków" --> KT
```
